...
namespace ET
{
    ...
    public static class UserDataType
    {
        ...
        public const int V1TotalPoints = 37;               //活动积分
    ...
    /// </summary>
#if SERVER
    public class RoleInfoComponent : Entity, IAwake, IDestroy, ITransfer, IUnitCache
#else
     public class RoleInfoComponent : Entity, IAwake
#endif
    {
