...
namespace ET
{
    ...
    public class C2M_ItemEquipIndexHandler : AMActorLocationRpcHandler<Unit, C2M_ItemEquipIndexRequest, M2C_ItemEquipIndexResponse>
    {
        protected override async ETTask Run(Unit unit, C2M_ItemEquipIndexRequest request, M2C_ItemEquipIndexResponse response, Action reply)
        {
            ...
            BagInfo equip_0 = bagComponentServer.GetEquipBySubType(ItemLocType.ItemLocEquip, (int)EquipCaoWeiTypeEnum.Wuqi_1);
            BagInfo equip_1 = null;///bagComponentServer.GetEquipBySubType(ItemLocType.ItemLocEquip_2, (int)EquipCaoWeiTypeEnum.Wuqi);
            ...
            //交换装备位置
           // unit.GetComponent<BagComponentServer>().OnChangeItemLoc(equip_0, ItemLocType.ItemLocEquip_2, ItemLocType.ItemLocEquip);
            //unit.GetComponent<BagComponentServer>().OnChangeItemLoc(equip_1, ItemLocType.ItemLocEquip, ItemLocType.ItemLocEquip_2);
            ...
            unit.GetComponent<NumericComponent>().ApplyValue(NumericType.Now_Weapon, bagComponentServer.GetWuqiItemId());
