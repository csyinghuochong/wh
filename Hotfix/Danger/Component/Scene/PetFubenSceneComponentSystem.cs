...
namespace ET
{
    ...
    public static class PetFubenSceneComponentSystem
    {
        ...
        public static void OnGameOver(this PetFubenSceneComponent self)
        {
            ...
            bool allMonsterDead = SceneCreatureHelp.IsAllMonsterDead(self.DomainScene(), self.MainUnit);
            int alivedPetNumber = SceneCreatureHelp.GetAlivePetNumber(self.DomainScene());
            int number = 0;
        ...
        public static void GenerateCellMonsters(this PetFubenSceneComponent self, string cellInfo, int index)
        {
            ...
            for (int i = 0; i < monsters.Length; i++)
			{
                ...
                for (int c = 0; c < cmcount; c++)
                {
                    ...
                    monsterunit.GetComponent<NumericComponent>().Set( NumericType.UnitCellIndex, index, false);
                }
            }
		}
    }
