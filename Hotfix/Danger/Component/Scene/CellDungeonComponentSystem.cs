    ...
    public static class CellDungeonComponentSystem
    {
        ...
        public static void OnKillEvent(this CellDungeonComponent self)
        {
            if(self.IsAllMonsterDead() && self.CurrentFubenCell.ctype == (int)CellDungeonStatu.End)
            {
                ...
                self.MainUnit.GetComponent<RoleInfoComponentServer>().UpdateRoleData(UserDataType.Exp, chapterConfig.RewardExp.ToString(), true, ItemGetWay.FubenGetReward);
                self.MainUnit.GetComponent<RoleInfoComponentServer>().UpdateRoleData(UserDataType.Gold, chapterConfig.RewardGold.ToString(), true, ItemGetWay.FubenGetReward);
