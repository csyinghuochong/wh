...
namespace ET
{
    public static class ActivityComponentServerSystem
    {
        ...
        public static bool HaveLoginReward(this ActivityComponentServer self)
        {
            ...
            return CommonHelper.GetDayByTime(TimeHelper.ServerNow()) != CommonHelper.GetDayByTime(self.LastLoginTime);
        }

        public static void OnZeroClockUpdate(this ActivityComponentServer self)
        {
            //重置每日特惠
            for (int i = self.ActivityReceiveIds.Count - 1; i >= 0; i--)
            {
            ...
            EventType.UpdateTimerChouKa.Instance.ZoneScene = self.ZoneScene();
            EventType.UpdateTimerChouKa.Instance.Par0 = null;
            EventType.UpdateTimerChouKa.Instance.Par1 = 0;
            EventSystem.Instance.PublishClass(EventType.UpdateTimerChouKa.Instance);
        }

        public static void OnRecvActivityInfo(this ActivityComponentServer self, M2C_ActivityInfoResponse r2c_roleEquip)
        {
        ...
        public static async ETTask<int> SendTimerChouKaRequest(this ActivityComponentServer self)
        { 
        ...
        public static async ETTask<int> GetActivityReward(this ActivityComponentServer self, int activityType, int activityId)
        {
            try
            {
        ...
        public static async ETTask<int> GetZhanQuActivityReward(this ActivityComponentServer self, int activityType, int activityId)
        {
