...
namespace ET
{
    ...
    [ActorMessageHandler]
    public class Other2R_SaveAccountHandler : AMActorRpcHandler<Scene, Other2R_SaveAccount, R2Other_SaveAccount>
    {
        protected override async ETTask Run(Scene scene, Other2R_SaveAccount request, R2Other_SaveAccount response, Action reply)
        { 
