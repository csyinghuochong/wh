...
namespace ET
{
    ...
    public class C2R_GMInfoHandler : AMRpcHandler< C2R_GMInfoRequest, R2C_GMInfoResponse>
    {
        protected override async ETTask Run(Session session, C2R_GMInfoRequest request, R2C_GMInfoResponse response, Action reply)
        {
