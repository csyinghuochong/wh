...
namespace ET
{
    ...
    [MessageHandler]
    public class C2R_PhoneBingingHandler : AMRpcHandler<C2R_PhoneBinging, R2C_PhoneBinging>
    {
        protected override async ETTask Run(Session session, C2R_PhoneBinging request, R2C_PhoneBinging response, Action reply)
        {
