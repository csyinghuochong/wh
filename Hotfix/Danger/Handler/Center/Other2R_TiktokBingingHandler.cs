...
namespace ET
{
    ...
    [ActorMessageHandler]
    public class Other2R_TiktokBingingHandler : AMActorRpcHandler<Scene, Other2R_TiktokBinging, R2Other_TiktokBinging>
    {
        protected override async ETTask Run(Scene scene, Other2R_TiktokBinging request, R2Other_TiktokBinging response, Action reply)
        {
