...
{
    [ActorMessageHandler]
    public class M2R_ShareSucessHandler : AMActorRpcHandler<Scene, M2R_ShareSucessRequest, R2M_ShareSucessResponse>
    {
        protected override async ETTask Run(Scene scene, M2R_ShareSucessRequest request, R2M_ShareSucessResponse response, Action reply)
        {
