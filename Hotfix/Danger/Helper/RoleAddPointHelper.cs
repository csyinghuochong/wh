...
namespace ET
{
    ...
    public static class RoleAddPointHelper
    {
        ...
        /// <summary>0 级为 0 点；每升 1 级增加固定 + 自由部分。</summary>
        ...
        public static int GetRemainPoint(Unit unit, int[] assignedPoints)
        {
            return GetTotalPointAtLevel(unit.GetComponent<RoleInfoComponent>().RoleInfo.Lv) - SumPoints(assignedPoints);
        }
