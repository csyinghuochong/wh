...
namespace ET
{
    ...
    public class Skill_ChainLightning_3: SkillHandler
    {
        ...
        public override void OnUpdate()
        {
            ...
            {
                this.TheUnitTarget = AIGetTargetHelp.GetNearestEnemy(this.TheUnitFrom, (float)this.LdSkillConf.Range_Type_Param1, true);
            ...
            this.TheUnitTarget = AIGetTargetHelp.GetNearestUnit(this.TheUnitFrom, lastTarget.Position, (float)this.LdSkillConf.Range_Type_Param1, this.HurtIds);
