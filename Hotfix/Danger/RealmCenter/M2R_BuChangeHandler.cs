...
namespace ET
{
    ...
    [ActorMessageHandler]
    public class M2R_BuChangeHandler : AMActorRpcHandler<Scene, M2R_BuChangeRequest, R2M_BuChangeResponse>
    {

        protected override async ETTask Run(Scene scene, M2R_BuChangeRequest request, R2M_BuChangeResponse response, Action reply)
        {
