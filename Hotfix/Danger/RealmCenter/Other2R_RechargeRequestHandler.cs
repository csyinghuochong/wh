...
namespace ET
{
    ...
    [ActorMessageHandler]
    public class Other2R_RechargeRequestHandler : AMActorRpcHandler<Scene, Other2R_RechargeRequest, R2Other_RechargeResponse>
    {
        protected override async ETTask Run(Scene scene, Other2R_RechargeRequest request, R2Other_RechargeResponse response, Action reply)
        {
